...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactSideEffect = __webpack_require__(238);
	...
	var _HelmetUtils = __webpack_require__(237);
	
	var _HelmetConstants = __webpack_require__(105);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _exenv = __webpack_require__(192);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ApiForm = function (_React$Component) {
	  _inherits(ApiForm, _React$Component);
	  ...
	  function ApiForm() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
	      apiKey: _this.props.init.apiKey,
	      clientId: _this.props.init.clientId
	      ...
	      return _this.setState((_this$setState = {}, _this$setState[key] = value, _this$setState));
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  ApiForm.prototype.render = function render() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DynamicSpreadsheet = __webpack_require__(114);
	
	var _DynamicSpreadsheet2 = _interopRequireDefault(_DynamicSpreadsheet);
	
	var _ApiForm = __webpack_require__(112);
	
	var _ApiForm2 = _interopRequireDefault(_ApiForm);
	
	var _Blob = __webpack_require__(62);
	...
	var SheetsDemo = function SheetsDemo(props) {
	  return _react2.default.createElement(
	    _modules.GoogleSheetsApi,
	    { clientId: props.clientId, apiKey: props.apiKey },
	    function (_ref) {
	      var authorize = _ref.authorize,
	          apiLoading = _ref.loading,
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        apiLoading ? _react2.default.createElement(
	          'div',
	          null,
	          'Loading...'
	        ) : error ? _react2.default.createElement(_Blob2.default, { data: error }) : signedIn ? _react2.default.createElement(
	          'button',
	          { onClick: signout },
	          'Sign Out'
	        ...
	        signedIn && _react2.default.createElement(_DynamicSpreadsheet2.default, null)
	      );
	    }
	  );
	};
	...
	var App = function (_React$Component) {
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
	      ...
	      clientId: '377437361891-v0ib2hve7mupdcpsibtuqr35o2h61op9.apps.googleusercontent.com'
	    }, _this.handleSubmit = function (state) {
	      return _this.setState(state);
	    }, _this.reset = function () {
	      return _this.setState({ apiKey: '', clientId: '' });
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  App.prototype.render = function render() {
	    return _react2.default.createElement(
	      ...
	      this.state.apiKey ? _react2.default.createElement(SheetsDemo, {
	        apiKey: this.state.apiKey,
	        clientId: this.state.clientId,
	        reset: this.reset
	      }) : _react2.default.createElement(_ApiForm2.default, { onSubmit: this.handleSubmit, init: this.state })
	    );
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MyData = function MyData(_ref) {
	  var data = _ref.data,
	      render = _ref.render;
	
	  var Comp = RenderChoices[render];
	  return _react2.default.createElement(Comp, { data: data });
	};
	
	// Wraps the GoogleSheet component to provide some basic components
	// for display loading & error states
	var SimpleGSheet = function SimpleGSheet(props) {
	  return _react2.default.createElement(
	    _modules.GoogleSheet,
	    { id: props.id, range: props.range },
	    function (_ref2) {
	      var error = _ref2.error,
	          data = _ref2.data,
	          loading = _ref2.loading;
	      return loading ? 'Getting data...' : error ? JSON.stringify(error, null, 2) : data ? _react2.default.createElement(MyData, { data: data, render: props.render }) : null;
	    }
	  );
	};
	
	var DynamicSpreadsheet = function (_React$Component) {
	  _inherits(DynamicSpreadsheet, _React$Component);
	
	  function DynamicSpreadsheet() {
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, DynamicSpreadsheet);
	  ...
	  DynamicSpreadsheet.prototype.render = function render() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(
	      ...
	      this.state.submitted && _react2.default.createElement(SimpleGSheet, {
	  ...
	  return DynamicSpreadsheet;
	}(_react2.default.Component);
	
	exports.default = DynamicSpreadsheet;
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Octokitty = function Octokitty(props) {
	  return _react2.default.createElement(
	    'a',
	    {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.options.map(function (str) {
	            return _react2.default.createElement(
	              'option',
	              { value: str, key: str },
	              str
	...
	var Table = function Table(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'tbody',
	      null,
	      data.slice(1).map(function (row, i) {
	        return _react2.default.createElement(
	          'tr',
	          { key: i },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Octokitty = __webpack_require__(115);
	
	var _Octokitty2 = _interopRequireDefault(_Octokitty);
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_Octokitty2.default, { repo: 'lourd/react-google-sheets' }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.GoogleSheetsApi = exports.GoogleApiConsumer = undefined;
	...
	var _reactBroadcast = __webpack_require__(244);
	...
	var _createContext = (0, _reactBroadcast.createContext)(null),
	    GoogleApiProvider = _createContext.Provider,
	    GoogleApiConsumer = _createContext.Consumer;
	
	GoogleApiProvider.displayName = 'GoogleApiProvider';
	GoogleApiConsumer.displayName = 'GoogleApiConsumer';
	
	var GoogleApi = function (_React$Component) {
	  _inherits(GoogleApi, _React$Component);
	  ...
	  function GoogleApi() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.authorize = function () {
	      if (_this.auth) {
	        _this.auth.signIn();
	      }
	      ...
	      loading: true,
	      error: null,
	      authorize: _this.authorize,
	      signout: _this.signout
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  GoogleApi.prototype.componentDidMount = function componentDidMount() {
	    this.setupApi();
	  };
	
	  GoogleApi.prototype.setupApi = function () {
	    var _ref = _asyncToGenerator(function* () {
	      var _this2 = this;
	
	      try {
	        if (typeof window.gapi === 'undefined') {
	          yield (0, _loadScript2.default)('https://apis.google.com/js/api.js');
	        }
	        if (!gapi.client) {
	      ...
	      this.auth.isSignedIn.listen(function (signedIn) {
	        return _this2.setState({ signedIn: signedIn });
	      });
	    });
	  ...
	  GoogleApi.prototype.render = function render() {
	    return _react2.default.createElement(
	      GoogleApiProvider,
	      { value: this.state },
	...
	GoogleApi.propTypes = {
	  clientId: _propTypes2.default.string.isRequired,
	  apiKey: _propTypes2.default.string.isRequired,
	  discoveryDocs: _propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,
	  scopes: _propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,
	  children: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.node]).isRequired
	};
	
	
	var GoogleSheetsApi = function GoogleSheetsApi(props) {
	  return _react2.default.createElement(GoogleApi, _extends({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GoogleApi = __webpack_require__(64);
	
	var _equalByKeys = __webpack_require__(120);
	
	var _equalByKeys2 = _interopRequireDefault(_equalByKeys);
	...
	var GSheetData = function (_React$Component) {
	  _inherits(GSheetData, _React$Component);
	
	  function GSheetData() {
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, GSheetData);
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
	      ...
	      data: null,
	      loading: false
	    }, _this.fetch = _asyncToGenerator(function* () {
	      ...
	      try {
	        ...
	        var response = yield _this.props.api.client.sheets.spreadsheets.values.get(params);
	        ...
	        _this.setState({ loading: false, error: response.result.error });
	      }
	    }), _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  GSheetData.prototype.componentDidMount = function componentDidMount() {
	    this.fetch();
	  };
	
	  GSheetData.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
	    if (!(0, _equalByKeys2.default)(this.props, prevProps, 'id', 'range')) {
	      this.fetch();
	    }
	  };
	
	  GSheetData.prototype.render = function render() {
	...
	GSheetData.propTypes = {
	  ...
	  range: _propTypes2.default.string.isRequired,
	  api: _propTypes2.default.object.isRequired
	};
	
	
	var GoogleSheet = function GoogleSheet(props) {
	  return _react2.default.createElement(
	    _GoogleApi.GoogleApiConsumer,
	    null,
	    function (api) {
	      return _react2.default.createElement(GSheetData, _extends({ api: api }, props));
	    }
	  );
	};
...
/***/ (function(module, exports) {
	...
	exports.__esModule = true;
	exports.default = equalByKeys;
	function equalByKeys(objA, objB) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, 'GoogleApi', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_GoogleApi).default;
	  }
	});
	Object.defineProperty(exports, 'GoogleApiConsumer', {
	  enumerable: true,
	  get: function get() {
	    return _GoogleApi.GoogleApiConsumer;
	  }
	});
	Object.defineProperty(exports, 'GoogleSheetsApi', {
	  enumerable: true,
	  get: function get() {
	    return _GoogleApi.GoogleSheetsApi;
	  }
	});
	
	var _GoogleSheet = __webpack_require__(119);
...
//# sourceMappingURL=component---src-pages-index-js-1309ea07963c6b2e9059.js.map