(function (global, factory) {
	...
	(factory((global.ReactGoogleSheet = {}),global.React));
...
if (undefined !== 'production') {
  var invariant$2$1 = invariant_1$2;
  var warning$1$1 = warning_1$2;
  var ReactPropTypesSecret$2$1 = ReactPropTypesSecret_1$2;
    ...
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        ...
        try {
          // This is intentionally an invariant that gets caught. It's the same
          // behavior as without this statement except with a better message.
          invariant$2$1(typeof typeSpecs[typeSpecName] === 'function', '%s: %s type `%s` is invalid; it must be a function, usually from ' + 'the `prop-types` package, but received `%s`.', componentName || 'React class', location, typeSpecName, typeof typeSpecs[typeSpecName]);
          error = typeSpecs[typeSpecName](values, typeSpecName, componentName, location, null, ReactPropTypesSecret$2$1);
        } catch (ex) {
          error = ex;
        }
...
function makeEmptyFunction$1$1(arg) {
  return function () {
    return arg;
  };
}
 ...
 * always need to be callable, since JS lacks a null-call idiom ala Cocoa.
 */
var emptyFunction$2$1 = function emptyFunction() {};

emptyFunction$2$1.thatReturns = makeEmptyFunction$1$1;
emptyFunction$2$1.thatReturnsFalse = makeEmptyFunction$1$1(false);
emptyFunction$2$1.thatReturnsTrue = makeEmptyFunction$1$1(true);
emptyFunction$2$1.thatReturnsNull = makeEmptyFunction$1$1(null);
emptyFunction$2$1.thatReturnsThis = function () {
  return this;
};
emptyFunction$2$1.thatReturnsArgument = function (arg) {
  return arg;
};

var emptyFunction_1$2$1 = emptyFunction$2$1;
...
var validateFormat$1$1 = function validateFormat(format) {};

if (undefined !== 'production') {
  validateFormat$1$1 = function validateFormat(format) {
    if (format === undefined) {
      throw new Error('invariant requires an error message argument');
    }
  };
...
function invariant$3$1(condition, format, a, b, c, d, e, f) {
  validateFormat$1$1(format);
...
var warning$2$1 = emptyFunction_1$2$1;

if (undefined !== 'production') {
  var printWarning$1$1 = function printWarning(format) {
    for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }
  ...
  warning$2$1 = function warning(condition, format) {
    if (format === undefined) {
      throw new Error('`warning(condition, format, ...args)` requires a warning ' + 'message argument');
    }
...
var propIsEnumerable$1$1 = Object.prototype.propertyIsEnumerable;

function toObject$1$1(val) {
	if (val === null || val === undefined) {
		throw new TypeError('Object.assign cannot be called with null or undefined');
	}
...
var objectAssign$2$1 = shouldUseNative$1$1() ? Object.assign : function (target, source) {
	var from;
	var to = toObject$1$1(target);
	var symbols;
	...
	for (var s = 1; s < arguments.length; s++) {
		...
		if (getOwnPropertySymbols$1$1) {
			symbols = getOwnPropertySymbols$1$1(from);
			for (var i = 0; i < symbols.length; i++) {
				if (propIsEnumerable$1$1.call(from, symbols[i])) {
					to[symbols[i]] = from[symbols[i]];
				}
			}
		}
...
var ReactPropTypesSecret$3$1 = 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED';

var ReactPropTypesSecret_1$2$1 = ReactPropTypesSecret$3$1;

if (undefined !== 'production') {
  var invariant$1$1 = invariant_1$2$1;
  var warning$1$1$1 = warning_1$2$1;
  var ReactPropTypesSecret$1$1 = ReactPropTypesSecret_1$2$1;
  var loggedTypeFailures$1$1 = {};
}
 ...
 * @private
 */
function checkPropTypes$2$1(typeSpecs, values, location, componentName, getStack) {
  if (undefined !== 'production') {
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        var error;
        ...
        warning$1$1$1(!error || error instanceof Error, '%s: type specification of %s `%s` is invalid; the type checker ' + 'function must return `null` or an `Error` but returned a %s. ' + 'You may have forgotten to pass an argument to the type checker ' + 'creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and ' + 'shape all require an argument).', componentName || 'React class', location, typeSpecName, typeof error);
        if (error instanceof Error && !(error.message in loggedTypeFailures$1$1)) {
          // Only monitor this failure once because there tends to be a lot of the
          // same error.
          loggedTypeFailures$1$1[error.message] = true;

          var stack = getStack ? getStack() : '';

          warning$1$1$1(false, 'Failed %s type: %s%s', location, error.message, stack != null ? stack : '');
        }
      }
    }
  }
...
var checkPropTypes_1$2$1 = checkPropTypes$2$1;

var factoryWithTypeCheckers$2$1 = function(isValidElement, throwOnDirectAccess) {
  /* global Symbol */
  var ITERATOR_SYMBOL = typeof Symbol === 'function' && Symbol.iterator;
  var FAUX_ITERATOR_SYMBOL = '@@iterator'; // Before Symbol spec.
  ...
  function createChainableTypeChecker(validate) {
    ...
    function checkType(isRequired, props, propName, componentName, location, propFullName, secret) {
      ...
      if (secret !== ReactPropTypesSecret_1$2$1) {
        if (throwOnDirectAccess) {
          // New behavior only for users of `prop-types` package
          invariant_1$2$1(
            false,
  ...
  function createAnyTypeChecker() {
    return createChainableTypeChecker(emptyFunction_1$2$1.thatReturnsNull);
  }
  ...
  function createArrayOfTypeChecker(typeChecker) {
    function validate(props, propName, componentName, location, propFullName) {
      ...
      for (var i = 0; i < propValue.length; i++) {
        var error = typeChecker(propValue, i, componentName, location, propFullName + '[' + i + ']', ReactPropTypesSecret_1$2$1);
        if (error instanceof Error) {
          return error;
        }
      }
  ...
  function createEnumTypeChecker(expectedValues) {
    if (!Array.isArray(expectedValues)) {
      undefined !== 'production' ? warning_1$2$1(false, 'Invalid argument supplied to oneOf, expected an instance of array.') : void 0;
      return emptyFunction_1$2$1.thatReturnsNull;
    }
  ...
  function createObjectOfTypeChecker(typeChecker) {
    function validate(props, propName, componentName, location, propFullName) {
      ...
      for (var key in propValue) {
        if (propValue.hasOwnProperty(key)) {
          var error = typeChecker(propValue, key, componentName, location, propFullName + '.' + key, ReactPropTypesSecret_1$2$1);
          if (error instanceof Error) {
            return error;
          }
        }
  ...
  function createUnionTypeChecker(arrayOfTypeCheckers) {
    if (!Array.isArray(arrayOfTypeCheckers)) {
      undefined !== 'production' ? warning_1$2$1(false, 'Invalid argument supplied to oneOfType, expected an instance of array.') : void 0;
      return emptyFunction_1$2$1.thatReturnsNull;
    }
    ...
    function validate(props, propName, componentName, location, propFullName) {
      for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
        var checker = arrayOfTypeCheckers[i];
        if (checker(props, propName, componentName, location, propFullName, ReactPropTypesSecret_1$2$1) == null) {
          return null;
        }
      }
  ...
  function createShapeTypeChecker(shapeTypes) {
    function validate(props, propName, componentName, location, propFullName) {
      ...
      for (var key in shapeTypes) {
        ...
        var error = checker(propValue, key, componentName, location, propFullName + '.' + key, ReactPropTypesSecret_1$2$1);
        if (error) {
          return error;
        }
      }
  ...
  function createStrictShapeTypeChecker(shapeTypes) {
    function validate(props, propName, componentName, location, propFullName) {
      ...
      // We need to check all keys in case some are required but missing from
      // props.
      var allKeys = objectAssign$2$1({}, props[propName], shapeTypes);
      for (var key in allKeys) {
        var checker = shapeTypes[key];
        if (!checker) {
          return new PropTypeError(
  ...
  ReactPropTypes.checkPropTypes = checkPropTypes_1$2$1;
  ReactPropTypes.PropTypes = ReactPropTypes;

  return ReactPropTypes;
};

var factoryWithThrowingShims$2$1 = function() {
  function shim(props, propName, componentName, location, propFullName, secret) {
    if (secret === ReactPropTypesSecret_1$2$1) {
      // It is still safe when called from React.
      return;
  ...
  ReactPropTypes.checkPropTypes = emptyFunction_1$2$1;
  ReactPropTypes.PropTypes = ReactPropTypes;
...
if (undefined !== 'production') {
  ...
  // http://fb.me/prop-types-in-prod
  var throwOnDirectAccess = true;
  module.exports = factoryWithTypeCheckers$2$1(isValidElement, throwOnDirectAccess);
} else {
  // By explicitly using `prop-types` you are opting into new production behavior.
  // http://fb.me/prop-types-in-prod
  module.exports = factoryWithThrowingShims$2$1();
}
});
...
var invariant$3$1$1 = function(condition, format, a, b, c, d, e, f) {
...
var invariant_1$2$1$1 = invariant$3$1$1;
...
var warning$2$1$1 = function() {};

if (__DEV__) {
  warning$2$1$1 = function(condition, format, args) {
...
var warning_1$2$1$1 = warning$2$1$1;

function createDeprecationWarning() {
  var alreadyWarned = false;
  return function (message) {
    warning_1$2$1$1(alreadyWarned, message);
    alreadyWarned = true;
  };
}
...
var Broadcast = function (_React$Component) {
  ...
  Broadcast.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    invariant_1$2$1$1(this.props.channel === nextProps.channel, "You cannot change <Broadcast channel>");
...
Broadcast.propTypes = {
  channel: propTypes$1$1.string.isRequired,
  children: propTypes$1$1.node.isRequired,
  compareValues: propTypes$1$1.func,
  value: propTypes$1$1.any
};
...
Broadcast.contextTypes = {
  broadcasts: propTypes$1$1.object
};
Broadcast.childContextTypes = {
  broadcasts: propTypes$1$1.object.isRequired
};
...
var Subscriber = function (_React$Component) {
  ...
  Subscriber.prototype.getBroadcast = function getBroadcast() {
    ...
    invariant_1$2$1$1(this.props.quiet || broadcast, '<Subscriber channel="%s"> must be rendered in the context of a <Broadcast channel="%s">', this.props.channel, this.props.channel);
...
Subscriber.propTypes = {
  channel: propTypes$1$1.string.isRequired,
  children: propTypes$1$1.func,
  quiet: propTypes$1$1.bool
};
...
var valueTypes = {
  string: propTypes$1$1.string,
  number: propTypes$1$1.number,
  function: propTypes$1$1.func,
  boolean: propTypes$1$1.bool
};
...
function getPropType(value) {
  ...
  if (type === "object") {
    return Array.isArray(value) ? propTypes$1$1.array : propTypes$1$1.object;
  }

  return valueTypes[type] || propTypes$1$1.any;
}
  ...
  var Consumer = function (_React$Component2) {
    ...
    Consumer.prototype.componentDidMount = function componentDidMount() {
      ...
      if (this.broadcast) {
        ...
        warning_1$2$1$1(this.props.quiet, "<Consumer> was rendered outside the context of its <Provider>");
      }
    };
...
GoogleApi.propTypes = {
  clientId: propTypes$1.string.isRequired,
  apiKey: propTypes$1.string.isRequired,
  discoveryDocs: propTypes$1.arrayOf(propTypes$1.string).isRequired,
  scopes: propTypes$1.arrayOf(propTypes$1.string).isRequired,
  children: propTypes$1.oneOfType([propTypes$1.func, propTypes$1.node])
};

var asyncToGenerator$1 = function (fn) {
  return function () {
    var gen = fn.apply(this, arguments);
    return new Promise(function (resolve, reject) {
      function step(key, arg) {
...
class GSheetData extends React.Component {
  ...
  fetch() {
    ...
    return asyncToGenerator$1(function* () {
...
const GoogleSheet = props => React.createElement(
  GoogleApiConsumer,
  null,
  api => React.createElement(GSheetData, _extends$1({ api: api }, props))
);
...
const GoogleSheetsApi = (_ref) => {
  ...
  return React.createElement(GoogleApi, _extends$1({
    scopes: scopes,
